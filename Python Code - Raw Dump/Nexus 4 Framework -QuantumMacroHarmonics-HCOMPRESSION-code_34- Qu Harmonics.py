...
# Generate zeta zeros
num_zeros = 500  # Number of zeta zeros to use
...
plt.subplot(3, 1, 1)
plt.plot(padded_harmonics[511], label="Padded Binary Waveform", color='blue')
...
plt.subplot(3, 1, 2)
plt.plot(hashed_harmonics[:511], label="Hashed Binary Waveform", color='orange')
...
plt.subplot(3, 1, 3)
plt.plot(filtered_harmonics[:511], label="Filtered Harmonic Waveform", color='green')
