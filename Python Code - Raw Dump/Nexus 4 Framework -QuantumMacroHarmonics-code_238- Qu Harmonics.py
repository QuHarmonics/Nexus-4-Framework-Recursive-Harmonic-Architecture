def unfold_hash_to_512(hash_bits, target_length=512):
    ...
    while len(hash_array) < target_length-1:
...
# Execute with enforced 512-bit target size
hash_bits = "8f434346648f6b96df89dda901c5176b10a6d83961dd3c1ac88b59b2dc327aa4"
unfolded_hash = unfold_hash_to_512(hash_bits)
unfolded_hash, len(unfolded_hash)  # Ensure the hash reaches 512 bits.
