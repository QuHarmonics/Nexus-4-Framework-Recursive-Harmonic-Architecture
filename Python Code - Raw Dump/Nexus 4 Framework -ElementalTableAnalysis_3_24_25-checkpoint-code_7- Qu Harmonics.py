...
df_mass_diff_interp = pd.DataFrame({"Atomic Number": x_interp_clipped, "Rate of Change in Mass": mass_differences_interp})
...
df_mass_diff_interp['Within Range'] = df_mass_diff_interp['Rate of Change in Mass'].between(1.0, 1.999)
