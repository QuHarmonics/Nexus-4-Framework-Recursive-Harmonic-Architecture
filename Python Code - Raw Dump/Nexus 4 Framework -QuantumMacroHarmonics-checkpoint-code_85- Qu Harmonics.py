...
def quantum_wave_from_hash(hash_value, base=2):
    ...
    z = radius * np.sin(2 * theta) + np.cos(theta / 2)  # Quantum harmonic combinations
...
# Dump the H array (macro snapshot)
...
# Final 3D Visualization of Quantum Wave
fig = plt.figure(figsize=(10, 6))
ax = fig.add_subplot(111, projection='3d')
ax.plot(np.arange(len(quantum_wave)), quantum_wave, zs=0, zdir='z', label='Quantum Wave')
